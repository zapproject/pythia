...
./pythia --config=local_testnet_miners/config3.json stake deposit
./pythia --config=local_testnet_miners/config4.json stake deposit
./pythia --config=local_testnet_miners/config5.json stake deposit

<<com
./pythia --config=local_testnet_miners/config1.json mine -r
./pythia --config=local_testnet_miners/config2.json mine -r
./pythia --config=local_testnet_miners/config3.json mine -r
./pythia --config=local_testnet_miners/config4.json mine -r
./pythia --config=local_testnet_miners/config5.json mine -r
com
